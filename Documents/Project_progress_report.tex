...
\begin{figure}[!h]
    \begin{center}
    \includegraphics[width=0.6\textwidth]{Figs/hardcode_labels.png}
    \end{center}
    \caption{}
    \label{fig:hardcode_labels}
    \end{figure}    

\begin{figure}[!h]
\begin{center}
\includegraphics[width=1\textwidth]{Figs/hardcode_difference_output.png}
\end{center}
\caption{The template matching model in action: recognizing objects and labeling them with red before taking the difference.}
\label{fig:hardcode_labels_difference}
\end{figure}
